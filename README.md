...
Get-Clean bounces whitelisted users off the PowerShell Transcript Logs and flags anyone else who ran PowerShell (useful for catching phishing). Get-Clean was called et-NonAdmins at first, but I thought Get-Clean was more catch.
